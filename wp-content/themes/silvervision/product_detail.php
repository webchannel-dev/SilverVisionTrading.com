...
<div class="banner"> <a href="#"><img src="<?php bloginfo('stylesheet_directory');?>/common/images/delivery_banner2_small.png" width="184" height="64" alt="" class="delivery_banner" /></a>
<a href="#"><img src="<?php bloginfo('stylesheet_directory');?>/common/images/delivery_banner_small.png" width="185" height="65" alt="" class="delivery_banner" /></a>
<h1><?php the_title(); ?></h1>
</div>
