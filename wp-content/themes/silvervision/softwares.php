<?php
/*
Single Post Template: Softwares
          ...
          <div class="specs_table" style="margin-top:20px;">
            ...
            <div class="table_bg">
              <table width="648" border="0" cellspacing="0" cellpadding="0">
                <tr><?php  if(get_post_custom_values('part_number')!=null){ ?>
                  <td class="left_colum" width="190">Part Number</td>
                  <td><?php 
$values_array = get_post_custom_values('part_number');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('software_description')!=null){ ?>
                <tr>
                  <td class="left_colum">Software Description</td>
                  <td><?php 
$values_array = get_post_custom_values('software_description');
echo $values_array[0];
?></td>
...
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('version')!=null){ ?>
                <tr>
                  <td class="left_colum">Version</td>
                  <td><?php 
$values_array = get_post_custom_values('version');
echo $values_array[0];
?></td>
                </tr><?php }  ?>
