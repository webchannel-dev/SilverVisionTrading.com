<?php
/*
Single Post Template: Television
          ...
          <div class="specs_table" style="margin-top:20px;">
            ...
            <div class="table_bg">
              <table width="648" border="0" cellspacing="0" cellpadding="0">
                <tr><?php if(get_post_custom_values('television_model')!=null){ ?>
                  <td class="left_colum" width="190">Model</td>
                  <td><?php 
$values_array = get_post_custom_values('television_model');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('series')!=null){ ?>
                <tr>
                  <td class="left_colum">Series</td>
                  <td><?php 
$values_array = get_post_custom_values('series');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('video_1')!=null){ ?>
                <tr>
                  <td class="left_colum">Video</td>
                  <td><?php 
$values_array = get_post_custom_values('video_1');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('audio')!=null){ ?>
                <tr>
                  <td class="left_colum">Audio</td>
                  <td><?php 
$values_array = get_post_custom_values('audio');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('feature')!=null){ ?>
                <tr>
                  <td class="left_colum">Feature</td>
                  <td><?php 
$values_array = get_post_custom_values('feature');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('input_output')!=null){ ?>
                <tr>
                  <td class="left_colum">Input &amp; Output </td>
                  <td><?php 
$values_array = get_post_custom_values('input_output');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('design')!=null){ ?>
                <tr>
                  <td class="left_colum">Design</td>
                  <td><?php 
$values_array = get_post_custom_values('design');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('package_size_wxhxd')!=null){ ?>
                <tr>
                  <td class="left_colum">Package Size (WxHxD)x</td>
                  <td><?php 
$values_array = get_post_custom_values('package_size_wxhxd');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('package_weight_set_weight_with_stand_')!=null){ ?>
                <tr>
                  <td class="left_colum">Package weight Set weight with stand </td>
                  <td><?php 
$values_array = get_post_custom_values('package_weight_set_weight_with_stand_');
echo $values_array[0];
?></td>
