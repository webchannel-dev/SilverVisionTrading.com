          ...
          <div class="tab_container">
            ...
            <div class="tab_box">
              ...
              <div class="desc" id="li_ul_anchor2_2" style="display: none;">
                <?php $values_array = get_post_custom_values('warranty_');
echo $values_array[0];
?>
              </div>
          ...
          <div class="specs_table" style="margin-top:20px;">
            ...
            <div class="table_bg">
              <table width="648" border="0" cellspacing="0" cellpadding="0">
                <?php if(get_post_custom_values('display_1')!=null){ ?>
                <tr>
                  <td class="left_colum" width="190">Display</td>
                  <td><?php 
$values_array = get_post_custom_values('display_1');
echo $values_array[0];
?></td>
                </tr><?php }?>
		<?php if(get_post_custom_values('audio_1')!=null){ ?>
                <tr>
                  <td class="left_colum">Audio</td>
                  <td><?php 
$values_array = get_post_custom_values('audio_1');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('headphones')!=null){ ?>
                <tr>
                  <td class="left_colum">Headphones</td>
                  <td><?php 
$values_array = get_post_custom_values('headphones');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('tv_and_video')!=null){ ?>
                <tr>
                  <td class="left_colum">TV and video</td>
                  <td><?php 
$values_array = get_post_custom_values('tv_and_video');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('cameras_photos_and_video')!=null){ ?>
                <tr>
                  <td class="left_colum">Cameras, photos, and video</td>
                  <td><?php 
$values_array = get_post_custom_values('cameras_photos_and_video');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('wireless')!=null){ ?>
                <tr>
                  <td class="left_colum">Wireless</td>
                  <td><?php 
$values_array = get_post_custom_values('wireless');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('input_and_output')!=null){ ?>
                <tr>
                  <td class="left_colum">Input and output</td>
                  <td><?php 
$values_array = get_post_custom_values('input_and_output');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('sensors')!=null){ ?>
                <tr>
                  <td class="left_colum">Sensors</td>
                  <td><?php 
$values_array = get_post_custom_values('sensors');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('battery_and_power')!=null){ ?>
                <tr>
                  <td class="left_colum">Battery and power</td>
                  <td><?php 
$values_array = get_post_custom_values('battery_and_power');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('system_requirements')!=null){ ?>
                <tr>
                  <td class="left_colum">System requirements</td>
                  <td><?php 
$values_array = get_post_custom_values('system_requirements');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('languages')!=null){ ?>
                <tr>
                  <td class="left_colum">Languages</td>
                  <td><?php 
$values_array = get_post_custom_values('languages');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('whats_in_the_box_1')!=null){ ?>
                
                <tr>
                  <td class="left_colum">What's in the box</td>
                  <td><?php 
$values_array = get_post_custom_values('whats_in_the_box_1');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('capacity')!=null){ ?>
                <tr>
                  <td class="left_colum">Capacity</td>
                  <td><?php 
$values_array = get_post_custom_values('capacity');
echo $values_array[0];
?></td>
                </tr><?php } %>
