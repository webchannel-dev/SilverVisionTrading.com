...
?></td>
                ...
                <tr>
                  <td class="left_colum">Dimensions (WxHxD)</td>
                  <td><?php 
...
?></td>
                ...
                <tr>
                  <td class="left_colum">Color Available</td>
                  <td><?php 
...
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('video')!=null){ ?>
                <tr>
...
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('recording')!=null){ ?>
                <tr>
                  <td class="left_colum">Recording</td>
                  <td><?php 
$values_array = get_post_custom_values('recording');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('flash')!=null){ ?>
                <tr>
                  <td class="left_colum">Flash</td>
                  <td><?php 
$values_array = get_post_custom_values('flash');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('exposure_control')!=null){ ?>
                <tr>
                  <td class="left_colum">Exposure Control</td>
                  <td><?php 
$values_array = get_post_custom_values('exposure_control');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('optics')!=null){ ?>
                <tr>
                  <td class="left_colum">Optics</td>
                  <td><?php 
$values_array = get_post_custom_values('optics');
echo $values_array[0];
?></td>
                </tr><?php } if(get_post_custom_values('imaging')!=null){ ?>
                <tr>
                  <td class="left_colum">Imaging</td>
                  <td><?php 
$values_array = get_post_custom_values('imaging');
echo $values_array[0];
?></td>
