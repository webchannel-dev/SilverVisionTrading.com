<div class="wrap">
    ...
    <p>Welcome to Newsletter/Neswletter Pro from Mavaj Sun Co.</p>
    <p>
    ...
    <p>
        ...
        <a href="http://www.MavajSunCo.com/plugins/newsletter" target="_blank">this page</a> (opens on a new window)
        or go directly to the <a href="http://members.mavajsunco.com" target="_blank">Member's site</a> (opens in a new window).
    </p>
    <p>
        <strong>References to pages where leave comments or find support can be find
        on <a href="http://www.MavajSunCo.com/plugins/newsletter" target="_blank">this page</a> (opens on a new window).</strong>
    </p>
    <p>
    ...
    <p>
        ...
        info@MavajSunCo.com so I can complete it and clear any doubt</strong>.
    </p>

    <h3>F.A.Q.</h3>
    <p><strong>Nothing is working!</strong></p>
    <p>
        The plugin is working on my main site (<a href="http://www.MavajSunCo.com" target="_blank">www.MavajSunCo.com</a>),
